...
Each member of an account consumes a billable seat, whether they are added by invitation or provisioned through
[single sign-on](/v3/how-to-guides/cloud/manage-users/configure-sso#seats-and-billing). See the
[Prefect Cloud plans](https://www.prefect.io/pricing) for seat and pricing details.
